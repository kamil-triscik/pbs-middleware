...
<head>
    <title>Files successfully fetched</title>
...
<div class="body">
    ...
    <div>
        <h2>Files successfully fetched</h2>
    </div>
    <div class="content">
        <p>Files for download request with id <b>${id}</b> was <b style="color: green">successfully</b> fetched and they could be downloaded.</p>
        <table class="tg">
            <#if description??>
                <tr>
